 ...
 */
public class FragmentThree extends RootFragment {
    FragmentManager fm;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < rootApplication.getMenuBtnList().size(); i++) {
            if (rootApplication.getMenuBtnList().get(i).getName().equals("辅助功能")) {
        ...
        FragmentHelper.replaceFragmentNoBack(fm, navFragment, "辅助功能", null, R.id.layout_chird_fragment);

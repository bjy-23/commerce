...
public class SelectUnit extends RelativeLayout {
    ...
    public void init(){
        ...
        tvSelected.setTextColor(getResources().getColor(R.color.gray));
        tvSelected.setGravity(Gravity.RIGHT);
        tvSelected.setMinWidth(DWZH.dp(100));
    ...
    public void hideIndex(){
        if (tvSelected!=null)
            tvSelected.setCompoundDrawables(null,null,null,null);
    }

    public void cancel(){
        tvSelected.setClickable(false);
    }
}

...
public class JyqxdqBean {
    ...
    public class Result {
        ...
        public void setApprvFileNo(String apprvFileNo){
            this.apprvFileNo = apprvFileNo;
        }
        public String getApprvFileNo(){
            return this.apprvFileNo;
        }
        ...
        public void setApprvOrgan(String apprvOrgan){
            this.apprvOrgan = apprvOrgan;
        }
        public String getApprvOrgan(){
            return this.apprvOrgan;
        }
        ...
        public void setSpclTrdId(String spclTrdId){
            this.spclTrdId = spclTrdId;
        }
        public String getSpclTrdId(){
            return this.spclTrdId;
        }

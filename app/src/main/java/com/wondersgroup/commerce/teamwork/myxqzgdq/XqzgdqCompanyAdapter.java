...
public class XqzgdqCompanyAdapter extends BaseAdapter {
	...
	public XqzgdqCompanyAdapter(CompanyPersonBean data, Context context) {
		super();
		this.data = data;
		mContext = context;
	}
...
//		holder.getOne().setText("111111");
//		holder.getFour().setText("22222");

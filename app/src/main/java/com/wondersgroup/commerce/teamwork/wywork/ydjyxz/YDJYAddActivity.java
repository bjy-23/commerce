...
public class YDJYAddActivity extends AppCompatActivity{
    ...
    TextView tvSsfj2;
    @BindView(R.id.ydjy_ssgss1)
    TextView tvSsgss1;
    @BindView(R.id.ydjy_ssgss2)
    TextView tvSsgss2;
    @BindView(R.id.ydjy_ssxzjd1)
    TextView tvSsxzjd1;
    @BindView(R.id.ydjy_ssxzjd2)
    TextView tvSsxzjd2;
    @BindView(R.id.ydjy_pbmc1)
    TextView tvPbmc1;
    @BindView(R.id.ydjy_pbmc2)
    TextView tvPbmc2;
    @BindView(R.id.ydjy_bzhdz)
    TextView tvBzhdz;
    @BindView(R.id.ydjy_lu)
    TextView tvLu;
    @BindView(R.id.ydjy_long)
    TextView tvLong;
    @BindView(R.id.ydjy_hao1)
    TextView tvHao1;
    @BindView(R.id.ydjy_hao2)
    TextView tvHao2;
    @BindView(R.id.ydjy_shi)
    TextView tvShi;
    @BindView(R.id.ydjy_haopuwei)
    TextView tvHaopuwei;
    @BindView(R.id.ydjy_fjdz1)
    TextView tvFjdz1;
    @BindView(R.id.ydjy_fjdz2)
    TextView tvFjdz2;
    @BindView(R.id.ydjy_fjdz3)
    TextView tvFjdz3;
    @BindView(R.id.ydjy_fjdz4)
    TextView tvFjdz4;
    @BindView(R.id.ydjy_mplx1)
    TextView tvMplx1;
    @BindView(R.id.ydjy_mplx2)
    TextView tvMplx2;
    @BindView(R.id.ydjy_fxrq1)
    TextView tvFxrq1;
    @BindView(R.id.ydjy_fxrq2)
    TextView tvFxrq2;
    @BindView(R.id.ydjy_cljg1)
    TextView tvCljg1;
    @BindView(R.id.ydjy_cljg2)
    TextView tvCljg2;
    @BindView(R.id.ydjy_fxr1)
    TextView tvFxr1;
    @BindView(R.id.ydjy_fxr2)
    TextView tvFxr2;
    @BindView(R.id.ydjy_bz1)
    TextView tvBz1;
    @BindView(R.id.ydjy_bz2)
    TextView tvBz2;
    @BindView(R.id.ydjy_lxfs1)
    TextView tvLxfs1;
    @BindView(R.id.ydjy_lxfs2)
    TextView tvLxfs2;

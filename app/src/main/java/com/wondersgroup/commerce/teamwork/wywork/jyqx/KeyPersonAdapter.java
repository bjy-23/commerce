...
public class KeyPersonAdapter extends BaseAdapter {
	private JyqxdqJbxxBean data;
	private Context mContext;

	public JyqxdqJbxxBean getData() {
		return data;
	}

	public void setData(JyqxdqJbxxBean data) {
		this.data = data;
	}

	public KeyPersonAdapter(JyqxdqJbxxBean data, Context context) {
		super();
		this.data = data;
		mContext = context;
	}

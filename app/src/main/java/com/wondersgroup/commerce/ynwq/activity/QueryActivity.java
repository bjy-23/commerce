...
import com.wondersgroup.commerce.ynwq.adapter.FuchiAdapter;
import com.wondersgroup.commerce.ynwq.adapter.JinduAdapter;
import com.wondersgroup.commerce.ynwq.adapter.XiaoWeiComAdapter;
...
public class QueryActivity extends AppCompatActivity {
    ...
    @BindView(R.id.query_recycler)RecyclerView recycler;
    ...
    public void init(){
        ...
        if("JDCX".equals(type)){
            ...
            body.put("pageNo", "0");
            Call<JinduResult> call= ApiManager.ynWqApi.getProgress(body);
            ...
            body.put("pageNo", "0");
            Call<XwComResult> call=ApiManager.ynWqApi.getSupportInfoList(body);
            ...
            body.put("pageNo","0");
            Call<FuchiResult> call=ApiManager.ynWqApi.getSupportList(body);

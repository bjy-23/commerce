...
public class TJActivity extends AppCompatActivity implements View.OnClickListener{
    @BindView(R.id.spinner_toolbar)Toolbar toolbar;
    @BindView(R.id.spinner_toolbar_title)TextView title;
    @BindView(R.id.tj_square_one)StaticSquare squareOne;
    @BindView(R.id.tj_square_two)StaticSquare squareTwo;
    @BindView(R.id.tj_square_three)StaticSquare squareThree;
    @BindView(R.id.tj_square_four)StaticSquare squareFour;
    @BindView(R.id.tj_square_five)StaticSquare squareFive;
    @BindView(R.id.tj_square_six)StaticSquare squareSix;
    @BindView(R.id.tj_layout_single)LinearLayout single;
    @BindView(R.id.tj_layout_multi)LinearLayout multi;
    @BindView(R.id.tj_layout_double)LinearLayout layoutDoule;
    @BindView(R.id.tj_square_single)StaticSquare squareSingle;
    @BindView(R.id.tj_square_multi_one)StaticSquare squareMulOne;
    @BindView(R.id.tj_square_multi_two)StaticSquare squareMulTwo;
    @BindView(R.id.tj_square_multi_three)StaticSquare squareMulThr;
    @BindView(R.id.tj_square_double_one)StaticSquare squareDoubleOne;
    @BindView(R.id.tj_square_double_two)StaticSquare squareDoubleTwo;

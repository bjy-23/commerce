...
public class CaseQueryResult {
    ...
    private List<CaseInvestigateTitle> result = new ArrayList<CaseInvestigateTitle>();
    ...
    public List<CaseInvestigateTitle> getResult() {
        return result;
    }

    public void setResult(List<CaseInvestigateTitle> result) {
        this.result = result;
    }
}

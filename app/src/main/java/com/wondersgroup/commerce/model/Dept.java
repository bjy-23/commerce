...
public class Dept {
    ...
    public class OrganInfo {
        ...
        private ArrayList<OrganInfo> organList = new ArrayList<OrganInfo>();

        public ArrayList<OrganInfo> getOrganList() {
            return organList;
        }



        public void setOrganList(ArrayList<OrganInfo> organList) {

 ...
 */
public class Title4RowAdapter extends RecyclerView.Adapter<Title4RowAdapter.ViewHolder>{
    ...
    public Title4RowAdapter(List<Title4RowItem> items) {
        this.items = items;
    }

    @Override
    public Title4RowAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.view_title4row_item,parent,false);
        ViewHolder holder=new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(Title4RowAdapter.ViewHolder holder, int position) {
        ...
        holder.rowForTitle.setText(item.getRowForTitle());
        ...
        holder.rowForContent.setText(item.getRowForContent());
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View itemView) {
            ...
            rowForTitle = (TextView) itemView.findViewById(R.id.item_row_for_title);
            ...
            rowForContent = (TextView) itemView.findViewById(R.id.item_row_for_content);

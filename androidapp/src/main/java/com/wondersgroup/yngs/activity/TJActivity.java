...
import com.wondersgroup.yngs.entity.TJItem;
import com.wondersgroup.yngs.entity.TJProcessItem;
...
import com.wondersgroup.yngs.widget.SpinnerDropDown;
import com.wondersgroup.yngs.widget.StaticSquare;
...
public class TJActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void fetchData(){
        ...
        if("SZBM".equals(type)){
            ...
            Call<TJResult> call= ApiManager.yunNanApi.getDeptStat(body);
            ...
            title.setText(dicItems.get(selection).getValue());
            Call<TJResult> call=ApiManager.yunNanApi.getInduStat(body);
            call.enqueue(new Callback<TJResult>() {
                @Override
                public void onResponse(Response<TJResult> response, Retrofit retrofit) {
                    progress.hide();
            ...
            Call<ChildOrganResult> call=ApiManager.yunNanApi.getChildOrgan(body);
                ...
                public void onResponse(Response<ChildOrganResult> response, Retrofit retrofit) {
                    if(response.isSuccess()&&response.body()!=null){
                        ...
                        if ("200".equals(result.getResultCode())){
                            ...
                            title.setText(dicItems.get(selection).getValue());
                            if("SZQY".equals(type)){
                                Call<TJResult> qyCall=ApiManager.yunNanApi.getAreaStat(body);
                                ...
                                Call<TJProcessResult> jzCall=ApiManager.yunNanApi.getProcStat(body);

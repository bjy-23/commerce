...
import com.wondersgroup.yngs.adapter.TongJiAdapter;
import com.wondersgroup.yngs.entity.StatItem;
...
public class TJDetailActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        Call<StatResult> call= ApiManager.yunNanApi.getStatList(body);

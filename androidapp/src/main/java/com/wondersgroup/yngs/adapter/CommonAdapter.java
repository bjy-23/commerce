...
import com.wondersgroup.yngs.entity.ThreeBean;
        ...
        switch (countNum) {
            case 3:
                if (convertView == null) {
                    ...
                    ht.oneLeft = (TextView) convertView.findViewById(R.id.one_left);
                    ht.twoLeft = (TextView) convertView.findViewById(R.id.two_left);
                    ht.threeLeft = (TextView) convertView
                            .findViewById(R.id.three_left);
                    ht.oneRight = (TextView) convertView
                            .findViewById(R.id.one_right);
                    ht.twoRight = (TextView) convertView
                            .findViewById(R.id.two_right);
                    ht.threeRight = (TextView) convertView
                            .findViewById(R.id.three_right);
            ...
            case 5:
                if (convertView == null) {
                    ...
                    ht.threeLeft = (TextView) convertView
                            .findViewById(R.id.three_left);
                    ht.fourLeft = (TextView) convertView
                            .findViewById(R.id.four_left);
                    ht.fiveLeft = (TextView) convertView
                            .findViewById(R.id.five_left);
                    ht.oneRight = (TextView) convertView
                            .findViewById(R.id.one_right);
                    ht.twoRight = (TextView) convertView
                            .findViewById(R.id.two_right);
                    ht.threeRight = (TextView) convertView
                            .findViewById(R.id.three_right);
                    ht.fourRight = (TextView) convertView
                            .findViewById(R.id.four_right);
                    ht.fiveRight = (TextView) convertView
                            .findViewById(R.id.five_right);
